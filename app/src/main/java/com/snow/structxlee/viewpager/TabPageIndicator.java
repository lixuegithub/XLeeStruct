...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    OnTabReselectedListener mTabReselectedListener;

	public int tabPadding = 40;
    ...
    protected void addTab(int index, CharSequence text, int iconResId) {
        ...
        tabView.setPadding(tabPadding , tabPadding /2 , tabPadding, tabPadding/2);
    ...
    public void setCurrentItem(int item) {
        ...
        Log.d("lxx", "mSelectedTabIndex===>"+mSelectedTabIndex);
        //Config.Recomand_Flag = mSelectedTabIndex;//XLee : ����Ĭ��ѡ���Ǹ��±�
